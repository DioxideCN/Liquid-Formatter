(() => {
    document.addEventListener("DOMContentLoaded", () => {
        const rootScript = document.getElementById("liquid-formatter");
        ...
        if (x6enable) {
            ...
            styleEl.setAttribute(
                "src",
                "/plugins/PluginLiquid/assets/static/lib/GraphHandler.js"
            );
        ...
        if (g2enable) {
            ...
            styleEl.setAttribute(
                "src",
                "/plugins/PluginLiquid/assets/static/lib/ChartHandler.js"
            );
            shadowDOM.appendChild(styleEl);
        }
